      ...
      <React.Fragment>
        <header>
          ...
          <button
            ...
            className="interrobang"
          >
            ‽
          </button>
          <p>
            In each round there are ten points available for the artists, ten
            points for the songs, and up to ten bonus points for the connection,
            depending on how soon you get it.
          </p>
          <p>
            Each connection also applies to the first song of the next round,
            which can be thought of as a reject from the previous round.
          </p>
