    ...
    return (
      <div className="App">
        <header>
          ...
          <button onClick={ () => alert("DO NOT REFRESH THE PAGE WHILE PLAYING.\nSongs appear in their original order (except the ones I've replaced) but can be listened to in any order. Connections could be between the songs, or the artists, or both (usually both). Most are wordy, some are a bit more interesting. With every new song you play, the number of available bonus points will go down. So, as soon as you know what the connection is, summarise it in the box (don't overthink this) and submit. You will only get one guess!\nFor songs and artists, just type your answers in the corresponding boxes, before selecting Mark Answers. I never thought I'd say this, but punctuation is not important. Spelling is, although the marking is not case-sensitive. I do not own any of these songs, but they are all good, except one.")} className="interrobang">‽</button>
        </header>
